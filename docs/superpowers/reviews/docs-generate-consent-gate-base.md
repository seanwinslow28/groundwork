...
> session"; the maintainer authorised the two doc slices as a bundle in this session's
> kickoff. Recorded here rather than left for a reader to notice. Rule 9 is the normative text — where
