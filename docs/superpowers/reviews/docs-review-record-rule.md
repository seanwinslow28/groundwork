...
> round must carry, and when it must be committed — and this header does not restate any
> of it. **This log's own addition, which rule 9 does not require:** each finding is
